...
class World {
    ...
    constructor(width:number, height:number) {
        ...
        var xCount = (width / 32) + 1;
        var yCount = (height / 32) + 1;
        ...
        for (var x = 0; x < xCount; x++) {
            ...
            for (var y = 0; y < yCount; y++) {
                ...
                if (Math.random() > 0.80) movable = 2;
                else movable = 1;

                this.world[x][y] = movable - 1;
                this.tiles[x][y] = new Tile(x, y, "img/spritesheet.png", movable)
            }
        }
    }

    getTileFromCell(cell) {
        return this.tiles[cell[0]][cell[1]]
    }
